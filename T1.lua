    ...
    spawn(function()
        while wait() do
            ...
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true and SaveSettings["Notifier"]['Select Method [Type]'] == "Method 2" then
                ...
                --Unit_Kill
                    --read
                local U1KillCountOld = game:GetService('HttpService'):JSONDecode(readfile('HolyShz/AnimeLastStand/data/U1Kill.txt'))
                local U2KillCountOld = game:GetService('HttpService'):JSONDecode(readfile('HolyShz/AnimeLastStand/data/U2Kill.txt'))
                local U3KillCountOld = game:GetService('HttpService'):JSONDecode(readfile('HolyShz/AnimeLastStand/data/U3Kill.txt'))
                local U4KillCountOld = game:GetService('HttpService'):JSONDecode(readfile('HolyShz/AnimeLastStand/data/U4Kill.txt'))
                local U5KillCountOld = game:GetService('HttpService'):JSONDecode(readfile('HolyShz/AnimeLastStand/data/U5Kill.txt'))
                local U6KillCountOld = game:GetService('HttpService'):JSONDecode(readfile('HolyShz/AnimeLastStand/data/U6Kill.txt'))
                    ...
                    ["embeds"] = {
                        {
                            ["title"] = "**Anime Last Stand **:",
                            ["author"] = {
                                ["name"] = "HolyShz Webhook - Anime Last Stand | Method 2 | Test Kill Count +- ",
                                ["icon_url"] = "https://tr.rbxcdn.com/4ea4281ed356c343bbecb671936d22cc/150/150/Image/Png",
                            },
                            ["image"] = {
                                ["url"] = "https://tr.rbxcdn.com/e893b8fc4ca334bdf84d9ae82e277667/768/432/Image/Png",
