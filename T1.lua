							...
							["fields"] = {
								...
								},
								{
									...
									["value"] = "```ini\n" .. 
												...
												"\n• Dimension Clear -> ".. comma_value(DataPlayers.StageClear.Value) ..
												"\n• Raid Clear -> ".. comma_value(DataPlayers.RaidClears.Value) ..
												"\n• Boss Rush Clear -> ".. comma_value(DataPlayers.BossRushClears.Value) ..
												"\n• Infinite Record -> ".. comma_value(DataPlayers.InfiniteRecord.Value) .. 
												"```"
									,
									["inline"] = false
								},
