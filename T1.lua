...
if not PandaAuth then
    PandaAuth = loadstring(game:HttpGet('https://raw.githubusercontent.com/SloGanzr/SloGanzr/main/TeSTLIB_PANDA_NEW.lua'))()
    if not PandaAuth then
        PandaAuth = tryLoadURL('https://raw.githubusercontent.com/SloGanzr/SloGanzr/main/TeSTLIB_PANDA_NEW.lua')
    end
end
