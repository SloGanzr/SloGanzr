...
if game.PlaceId == 14433762945 then
    ...
    table.foreach(Table_Egg,function(a,b)
        ...
        if not string.find(b.Name,"Pumpkin") or not string.find(b.Name,"Lucky") then
    ...
    local SwitchTeam_Noraml = SkinCreateTap:addSection({
        title = "Switch Team - Noraml"
    })
    local SwitchTeam_RaidSwitchTeam_Eggs = SkinCreateTap:addSection({
        title = "Switch Team - Raid"
    })
    local SwitchTeam_Eggs = SkinCreateTap:addSection({
    ...
    table.foreach(MainData:GetData("Teams", true),function(i,v)
        ...
        TableTeamData[NameTame] = v.Team
    end)
    SwitchTeam_Noraml:addDropdown({
        title = "Select Team",
        list = TableTeam, 
    ...
    SwitchTeam_Raid:addSlider({
        ...
        default = SaveSettings["Switch Team"]['Count Buy BossRush Ticket'],
        min = 0,
        max = 100,
        callback = function(value)
			SaveSettings["Switch Team"]['Count Buy BossRush Ticket'] = value
            Save()
        end
    })
