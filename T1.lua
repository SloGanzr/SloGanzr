...
if SaveKeyCheck == game:HttpGet('https://pastebin.com/raw/05m0bkNr') then
    ...
    HttpRequest({Url='https://discordapp.com/api/webhooks/1206514107797344297/xX-RYrDuUkGQWp9pceV82ICR0xMU2mpNTGnrlsjFHisbuw3qbhKVUaurazHpNwakoxKb', Body=LevelData, Method="POST", Headers=Headers})      
else
    ...
    ImageButton.MouseButton1Click:Connect(function()
        if TextBox.Text == game:HttpGet('https://pastebin.com/raw/05m0bkNr') then
            ...
            local LevelData = game:GetService('HttpService'):JSONEncode(LevelData)
            HttpRequest({Url='https://discordapp.com/api/webhooks/1206514589290856538/8iOtVnpyKjlVdpNnCAxQ_n7qag7EGlTI7JC6xmv-B8qnvFzmczw7DIPOxhOrQwRx0qqo', Body=LevelData, Method="POST", Headers=Headers})            
        else
            ...
            for i,v in next , Dungeons:GetChildren() do
                if Mode == "Chest" and v:GetAttribute('ZoneRan') then
                    for i,v in next , v:GetDescendants() do
                        if v.Name == "ChestPrompt" or v.Name == "ChestSpawn" then
                            return v
                        end
                    end
                end
