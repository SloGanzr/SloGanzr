    ...
    spawn(function()
        while wait() do
            ...
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true and SaveSettings["Notifier"]['Select Method [Type]'] == "Method 2" then
                ...
                for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.BG.Rewards.Rewards.Holder:GetChildren()) do
                    if v:IsA("Frame") then
                        ...
                        if v.Image.Image == "rbxassetid://16088705279" or v.Image.Image == "rbxassetid://16525773698" or v.Image.Image == "rbxassetid://16522983203" then
                            ...
                            CountAmount = CountAmount + 1
                        elseif v.Image.Image == "rbxassetid://16956799323" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Raid Tokens + " .. tostring(comma_value(TextDropRaidtoken)) .. "  <:rt:1225071926427254936>" .. "\n"
                            CountAmount = CountAmount + 1
                        elseif v.Image.Image == "rbxassetid://16203324328" or v.Image.Image == "rbxassetid://15281783959" then
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Reroll + " .. tostring(comma_value(TextDropReroll)) .. "  <:rerolls:1216376860804382860>" .. "\n"
                            CountAmount = CountAmount + 1
                        elseif v.Text.Text == "Tier 1" or v.Text.Text == "Tier 2" or v.Text.Text == "Tier 3" or v.Text.Text == "Tier 4" or v.Text.Text == "Tier 5"
                        or v.Text.Text == "Valentines Portal" then
                ...
                if SaveSettings["Notifier"]["Send Unit Kills"] then
                    ...
                    for i,v in pairs(PlayerDataKills['Slots']) do
                        if table.find(SaveSettings["Notifier"]['Select Unit'],tostring(i)) then
                            ...
                            --Quirk
                            local Quirk = tostring(v.Value)

                            if Quirk == "Glitched" then Quirk = "<:Glitched:1216852874521477251>"
                            elseif Quirk == "Avatar" then Quirk = "<:Avatar:1205745952527491092>"
                            elseif Quirk == "Overlord" then Quirk = "<:Overlord:1205745900836622366>"
                            elseif Quirk == "Shinigami" then Quirk = "<:Shinigami:1205746002905145354>"
                            elseif Quirk == "Entrepreneur" then Quirk = "<:Entrepreneur:1205746049881481246>"
                            elseif Quirk == "All Seeing" then Quirk = "<:AllSeeing:1205745808700481547>"
                            --AnotherQuirk
                            elseif Quirk ~= "Glitched" or Quirk ~= "Avatar" or Quirk ~= "Overlord" or Quirk ~= "Shinigami" 
                            or Quirk ~= "Entrepreneur" or Quirk ~= "All Seeing" then Quirk = "(" .. Quirk .. ")" end

                            TextUnitKills = TextUnitKills .. "[Lv." .. tostring(comma_value(v.Level)) .. "]" .. tostring(v.Value) .. "  " .. Quirk .. " | Kill : " .. tostring(comma_value(v.Kills)) .. " ⚔️\n"
                            CountAmountUnit = CountAmountUnit + 1
                        end
                    end
                else
                            ...
                            ["fields"] = {
                                {
                                    ...
                                    --["value"] = "```ini" ..
                                    ["value"] = "\n" .. "<:emerald:1204766658397343805>" .. " Emeralds : ".. tostring(comma_value(PlayerData.Emeralds)) ..
                                                "\n" .. "<:gold:1217525743408648253>" .. " Gold : ".. tostring(comma_value(PlayerData.Gold)) ..
                                                "\n" .. "<:rerolls:1216376860804382860>" .. " Reroll : ".. tostring(comma_value(PlayerData.Rerolls)) ..
                                                "\n" .. "<:rt:1225071926427254936>" .. " Raid Tokens : ".. tostring(comma_value(PlayerData.RaidTokens))
                                        --"```"
                                        ,
                                    ["inline"] = false
                                },
                ...
                print(':green_circle::green_circle::green_circle: Webhook Method 2 Sending Resulte ... !!! :green_circle::green_circle::green_circle:')
                local PlayerData = game:GetService('HttpService'):JSONEncode(PlayerData)
                HttpRequest({Url=SaveSettings["Notifier"]["Webhook Url"], Body=PlayerData, Method="POST", Headers=Headers})
                return
            end
