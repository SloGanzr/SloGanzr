...
if not PandaAuth then
    ...
    if not PandaAuth then
        PandaAuth = loadstring(game:HttpGet('https://raw.githubusercontent.com/SloGanzr/SloGanzr/main/Panda_LIB.lua'))()
    end
    return PandaAuth
end
...
if game.CoreGui:FindFirstChild("KeySystemGui") then game.CoreGui:FindFirstChild("KeySystemGui"):Destroy() end
    ...
    for i,v in pairs(ItemsDatainfo) do
        ...
        and i ~= "Tier 3" and i ~= "Tier 4" and i ~= "Tier 5" then
            ...
            if i == "Genos Core" then i = "Jenos Core" end
            if i == "GenosLeftArm" then i = "Jenos Left Arm" end
            if i == "GenosRightArm" then i = "Jenos Right Arm" end
            ...
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true and SaveSettings["Notifier"]['Select Method [Type]'] == "Method 1" then
                ...
                for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.BG.Rewards.Rewards.Holder:GetChildren()) do
                    if v:IsA("Frame") then
                        ...
                        or v.Text.Text == "Valentines Portal" then
                            ...
                            if v.Text.Text == "HeavenlyChad" then v.Text.Text = "Jotaro OH" end
                            if v.Text.Text == "Drip Nami" or v.Text.Text == "Drip Zami" then v.Text.Text = "Drip Nami" end
                            if v.Text.Text == "Golden Admiral" then v.Text.Text = "Sengoku" end
                            if v.Text.Text == "Gerp" then v.Text.Text = "Garp" end
                            if v.Text.Text == "Red Pirate (Young)" then v.Text.Text = "Young Shanks" end
                            if v.Text.Text == "Strongest Aline" then v.Text.Text = "Boros" end
                ...
                if SaveSettings["Notifier"]["Send All Item"] then
                    ...
                    for i,v in pairs(TableData['ItemData']) do
                        ...
                        if v.ItemName == "Devil Fruit" then v.ItemName = "Demon Fruit" end
                        --Spirit_Shard
                        ...
                        if v.ItemName == "Genos Core" then v.ItemName = "Jenos Core" end
                        if v.ItemName == "GenosLeftArm" then v.ItemName = "JenosLeftArm" end
                        if v.ItemName == "GenosRightArm" then v.ItemName = "JenosRightArm" end
                ...
                local testINI = "```"
                if testINI == "-595805986" or testINI == "```" then testINI = "```" end
                    ...
                    ["embeds"] = {
                        {
                            ...
                            ["author"] = {
                                ...
                                ["icon_url"] = "https://tr.rbxcdn.com/1f1fe656ca3c50139302f46cb5431b32/150/150/Image/png",
                            },
                            ["image"] = {
                    ...
                    if v:IsA("Frame") then
                        ...
                        elseif v.MainText.Text ~= "" then
                            ...
                            if v.Text.Text == "HeavenlyChad" or v.Text.Text == "HeavenlyChad (Jotaro OH)" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". HeavenlyChad (Jotaro OH) + 1  <:JotaroOH:1231422389766717442>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Drip Nami" or v.Text.Text == "Drip Zami" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Drip Nami + 1  <:DripZami:1231420403847663668>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Red Pirate (Young)" or v.Text.Text == "Red Pirate (Young) (Shanks)" then 
                                ...
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Golden Admiral" or v.Text.Text == "Sengoku" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Sengoku + 1  <:SenGoku:1231422392446746765>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Gerp" or v.Text.Text == "Garp" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Garp + 1  <:GARP:1229479636409520199>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Shiny Wish Dragon" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Shiny Wish Dragon + 1  <:WishDragon:1231478817743310889>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Strongest Aline" or v.Text.Text == "Boros" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Boros + 1  <:Boros:1232489469270036550>\n"
                                CountAmount = CountAmount + 1
                            --Item_Logoa
                            ...
                            elseif v.Text.Text == "Candy" or v.Text.Text == "Candy" then 
                                ...
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "LightSword" or v.Text.Text == "Light Sword" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Light Sword + 1  <:LightSword:1229479699995033682>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Admiral Durag" or v.Text.Text == "Aokijis Cape" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Aokijis Cape + 1  <:AokijisCape:1229479695058341948>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Admiral Cape" or v.Text.Text == "Admiral Cape" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Admiral Cape + 1  <:AdmiralCape:1229479692659200020>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Birb" or v.Text.Text == "Bird" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Bird + 1  <:Bird:1229479697092448430>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Tier 1" or v.Text.Text == "Tier 1 Portal" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Portal Tier 1 + 1  <:Tier1:1232491883419406387>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Tier 2" or v.Text.Text == "Tier 2 Portal" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Portal Tier 2 + 1  <:Tier2:1232491885814222948>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Tier 3" or v.Text.Text == "Tier 3 Portal" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Portal Tier 3 + 1  <:Tier3:1232491888599109662>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Tier 4" or v.Text.Text == "Tier 4 Portal" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Portal Tier 4 + 1  <:Tier4:1232491890692063393>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Tier 5" or v.Text.Text == "Tier 5 Portal" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Portal Tier 5 + 1  <:Tier5:1232491893124890628>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Valentines Portal" or v.Text.Text == "Valentines Portal" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Valentines Portal + 1  <:Valentine:1232492720531177483>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Devil Fruit" or v.Text.Text == "Demon Fruit" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Demon Fruit + 1  <:DemonFruit:1233084369703272511>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Ninja Headband" or v.Text.Text == "Ninja Headband" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Ninja Headband + 1  <:NinjaHeadband:1233084372400341073>\n"
                                CountAmount = CountAmount + 1
                            --Spirit_Shard
                            elseif v.Text.Text == "CommonSpiritShard" or v.Text.Text == "Common Spirit Shard" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Common Spirit Shard + 1  <:CommonSpiritShard:1232486716288405624>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "RareSpiritShard" or v.Text.Text == "Rare Spirit Shard" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Rare Spirit Shard + 1  <:RareSpiritShard:1232486726052614144>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "EpicSpiritShard" or v.Text.Text == "Epic Spirit Shard" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Epic Spirit Shard + 1  <:EpicSpiritShard:1232486718209523784>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "LegendarySpiritShard" or v.Text.Text == "Legendary Spirit Shard" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Legendary Spirit Shard + 1  <:LegendarySpiritShard:1232486720520585246>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "MythicSpiritShard" or v.Text.Text == "Mythic Spirit Shard" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Mythic Spirit Shard + 1  <:MythicSpiritShard:1232486723682828339>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Genos Core" or v.Text.Text == "Jenos Core" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Genos Core + 1  <:GenosCore:1232486949143711897>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "GenosLeftArm" or v.Text.Text == "JenosLeftArm" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Genos Left Arm + 1  <:GenosLeftArm:1232486951341391942>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "GenosRightArm" or v.Text.Text == "JenosRightArm" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Genos Right Arm + 1  <:GenosRightArm:1232486953321107456>\n"
                                CountAmount = CountAmount + 1
                            --EXP_ITEM
                            elseif v.Text.Text == "Tree Of Might Fruit" or v.Text.Text == "Tree Of Might Fruit" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Tree Of Might Fruit + 1  <:ThreeOfMightFruit:1232487019457024091>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Curse Talisman" or v.Text.Text == "Curse Talisman" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Curse Talisman + 1  <:CurseTalisman:1232487009554272256>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Ghoul Coffee" or v.Text.Text == "Ghoul Coffee" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Ghoul Coffee + 1  <:GhoulCoffee:1232487011936505987>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Capsule Corp Capsule" or v.Text.Text == "Capsule Corp Capsule" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Capsule Corp Capsule + 1  <:CapsuleCorpCapsule:1232487006840291339>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Ramen" or v.Text.Text == "Ramen" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Ramen + 1  <:Ramen:1232487014629376151>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Yokai Meat" or v.Text.Text == "Yokai Meat" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Yokai Meat + 1  <:YokaiMeat1:1232487022132727819>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Senzu Bean" or v.Text.Text == "Super Bean" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Super Bean + 1  <:SuperBean:1232487017083047998>\n"
                                CountAmount = CountAmount + 1
                            else
                    ...
                    for i,v in pairs(TableData['ItemData']) do
                        ...
                        if table.find(SaveSettings["Notifier"]['Select Item'],tostring(i)) or table.find(SaveSettings["Notifier"]['Select Item'],tostring(v.ItemName)) then
                            ...
                            elseif v.ItemName == "Birb" or v.ItemName == "Bird" then
                                ...
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Tier 1" or v.ItemName == "Tier 1 Portal" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Tier1:1232491883419406387>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Tier 2" or v.ItemName == "Tier 2 Portal" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Tier2:1232491885814222948>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Tier 3" or v.ItemName == "Tier 3 Portal" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Tier3:1232491888599109662>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Tier 4" or v.ItemName == "Tier 4 Portal" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Tier4:1232491890692063393>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Tier 5" or v.ItemName == "Tier 5 Portal" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Tier5:1232491893124890628>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Valentines Portal" or v.ItemName == "Valentines Portal" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Valentine:1232492720531177483>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Genos Core" or v.ItemName == "Jenos Core" then
                                ...
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "GenosLeftArm" or v.ItemName == "JenosLeftArm" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:GenosLeftArm:1232486951341391942>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "GenosRightArm" or v.ItemName == "JenosRightArm" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:GenosRightArm:1232486953321107456>\n"
                                CountAmountAll = CountAmountAll + 1
                            --Spirit_Shard
                            ...
                            elseif v.ItemName == "RareSpiritShard" or v.ItemName == "Rare Spirit Shard" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:RareSpiritShard:1232486726052614144>\n"
                                CountAmountAll = CountAmountAll + 1
                            ...
                            elseif v.ItemName == "LegendarySpiritShard" or v.ItemName == "Legendary Spirit Shard" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:LegendarySpiritShard:1232486720520585246>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "MythicSpiritShard" or v.ItemName == "Mythic Spirit Shard" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:MythicSpiritShard:1232486723682828339>\n"
                                CountAmountAll = CountAmountAll + 1
                            --EXP_Items
                            elseif v.ItemName == "Devil Fruit" or v.ItemName == "Demon Fruit" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:DemonFruit:1233084369703272511>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Ninja Headband" or v.ItemName == "Ninja Headband" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:NinjaHeadband:1233084372400341073>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Tree Of Might Fruit" or v.ItemName == "Tree Of Might Fruit" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:ThreeOfMightFruit:1232487019457024091>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Curse Talisman" or v.ItemName == "Curse Talisman" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:CurseTalisman:1232487009554272256>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Ghoul Coffee" or v.ItemName == "Ghoul Coffee" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:GhoulCoffee:1232487011936505987>\n"
                                CountAmountAll = CountAmountAll + 1
                            ...
                            elseif v.ItemName == "Ramen" or v.ItemName == "Ramen" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Ramen:1232487014629376151>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Yokai Meat" or v.ItemName == "Yokai Meat" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:YokaiMeat1:1232487022132727819>\n"
                                CountAmountAll = CountAmountAll + 1
                            elseif v.ItemName == "Senzu Bean" or v.ItemName == "Super Bean" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:SuperBean:1232487017083047998>\n"
                                CountAmountAll = CountAmountAll + 1
                            else
                        ...
                        if table.find(SaveSettings["Notifier"]['Select Unit'],tostring(i1)) then
                            ...
                            for i2,v2 in pairs(PlayerDataKillsInfo['UnitData']) do
                                if tostring(v1.UnitID) == tostring(v2.UnitID) then
                                    ...
                                    elseif QuirkName == "Accelerate3" then QuirkName = "<:Accelerate3:1228192934852169811>"
                                    elseif QuirkName == "Scoped3" then QuirkName = "<:Scoped3:1228192938887221390>"
                                    elseif QuirkName == "Sturdy3" then QuirkName = "<:Sturdy3:1228192931316236308>"
        ...
        while wait() do
            ...
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("EndGameUI") then
                ...
                elseif SaveSettings["Main"]['Manual Click [Next]'] and game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.BG.Buttons.Next.Visible == true then
                    wait(tonumber(tostring(SaveSettings["Main"]["Delay [Start,Retry,Leave]"])))
                    ClickNext =  LocalPlayer.PlayerGui.EndGameUI.BG.Buttons.Next.Button
                    repeat
                        wait()
                ...
                elseif SaveSettings["Main"]['Manual Click [Retry]'] and game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.BG.Buttons.Retry.Visible == true then
                    wait(tonumber(tostring(SaveSettings["Main"]["Delay [Start,Retry,Leave]"])))
                    ClickRetry =  LocalPlayer.PlayerGui.EndGameUI.BG.Buttons.Retry.Button
                    repeat
                        wait()
                        game:GetService("VirtualInputManager"):SendMouseButtonEvent(
                ...
                elseif SaveSettings["Main"]['Manual Click [Leave]'] and game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.BG.Buttons.Leave.Visible == true then
                    wait(tonumber(tostring(SaveSettings["Main"]["Delay [Start,Retry,Leave]"])))
                    ClickLeave =  LocalPlayer.PlayerGui.EndGameUI.BG.Buttons.Leave.Button
                    repeat
                        wait()
                        game:GetService("VirtualInputManager"):SendMouseButtonEvent(
    ...
    spawn(function()
        while wait() do
            if SaveSettings["SaveSetting"]['Auto TP to Zone'] and game.PlaceId ~= 12886143095 then
                ...
                local Random_Num_x = math.random(1,16)
                local Random_Num_z = math.random(1,15)
                ...
                elseif MapDataTabel.MapName  == "Super Hero City" then
                    if HumanoidRootPart.CFrame ~= "243.69090270996094, 139.4795684814453, 512.94091796875" then
                        ClickToMoveController:MoveTo(Vector3.new(243.69090270996094 + tonumber(Num_Up), 139.4795684814453, 512.94091796875 + tonumber(Num_Down)))
                        wait(180)
                        ClickToMoveController:MoveTo(Vector3.new(243.69090270996094 - tonumber(final_num_x), 139.4795684814453, 512.94091796875 - tonumber(final_num_z)))
                        wait(360)
                        ClickToMoveController:MoveTo(Vector3.new(243.69090270996094 + tonumber(final_num_x), 139.4795684814453, 512.94091796875 + tonumber(final_num_z)))
                        wait(540)
                        ClickToMoveController:MoveTo(Vector3.new(243.69090270996094 - tonumber(final_num_x), 139.4795684814453, 512.94091796875 - tonumber(final_num_z)))
                ...
                elseif MapDataTabel.MapName  == "Hero Association" then
                    if HumanoidRootPart.CFrame ~= "648.35791015625, 748.6799926757812, 124.304443359375" then
                        ClickToMoveController:MoveTo(Vector3.new(648.35791015625 + tonumber(Num_Up), 748.6799926757812, 124.304443359375 + tonumber(Num_Down)))
                        wait(180)
                        ClickToMoveController:MoveTo(Vector3.new(648.35791015625 - tonumber(final_num_x), 748.6799926757812, 124.304443359375 - tonumber(final_num_z)))
                        wait(360)
                        ClickToMoveController:MoveTo(Vector3.new(648.35791015625 + tonumber(final_num_x), 748.6799926757812, 124.304443359375 + tonumber(final_num_z)))
                        wait(540)
                        ClickToMoveController:MoveTo(Vector3.new(648.35791015625 - tonumber(final_num_x), 748.6799926757812, 124.304443359375 - tonumber(final_num_z)))
