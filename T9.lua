                ...
                if SaveSettings["Notifier"]["Send All Item"] then
                    ...
                    for i,v in pairs(TableData['ItemData']) do
                        ...
                        if table.find(SaveSettings["Notifier"]['Select Item'],tostring(i)) or table.find(SaveSettings["Notifier"]['Select Item'],tostring(v.ItemName)) then
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "\n"
            ...
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true and SaveSettings["Notifier"]['Select Method [Type]'] == "Method 2" then
                ...
                if SaveSettings["Notifier"]["Send All Item"] then
                    ...
                    for i,v in pairs(TableData['ItemData']) do
                        ...
                        if tostring(v.ItemName) == "WishBall1" or tostring(v.ItemName) == "Wish Ball 1" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Wish_Balls:1227137580785602671>\n"
                        elseif tostring(v.ItemName) == "WishBall2" or tostring(v.ItemName) == "Wish Ball 2" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Wish_Balls:1227137580785602671>\n"
                        elseif tostring(v.ItemName) == "WishBall3" or tostring(v.ItemName) == "Wish Ball 3" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Wish_Balls:1227137580785602671>"
                        elseif tostring(v.ItemName) == "WishBall4" or tostring(v.ItemName) == "Wish Ball 4" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Wish_Balls:1227137580785602671>"
                        elseif tostring(v.ItemName) == "WishBall5" or tostring(v.ItemName) == "Wish Ball 5" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Wish_Balls:1227137580785602671>"
                        elseif tostring(v.ItemName) == "WishBall6" or tostring(v.ItemName) == "Wish Ball 6" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Wish_Balls:1227137580785602671>"
                        elseif tostring(v.ItemName) == "WishBall7" or tostring(v.ItemName) == "Wish Ball 7" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Wish_Balls:1227137580785602671>"
                        elseif tostring(v.ItemName) == "MSymbol" or tostring(v.ItemName) == "Mean Symbol" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Mean_Symbol:1227137443984310333>"
                        elseif tostring(v.ItemName) == "RightEarring" or tostring(v.ItemName) == "Right Earring" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Earrings:1227137412103147532>"
                        elseif tostring(v.ItemName) == "LeftEarring" or tostring(v.ItemName) == "Left Earring" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Earrings:1227137412103147532>"
                        elseif tostring(v.ItemName) == "SixEyes" or tostring(v.ItemName) == "Six Eyes" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Six_Eye:1227137469770764319>"
                        elseif tostring(v.ItemName) == "Tor Headband" or tostring(v.ItemName) == "Tor's Headband" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Tors_Headband:1227137526213640223>"
                        elseif tostring(v.ItemName) == "Tor Cloak" or tostring(v.ItemName) == "Tor's Cloak" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Tors_Cloak:1227137511650758668>"
                        elseif tostring(v.ItemName) == "LamiCloud" or tostring(v.ItemName) == "Lami Cloud" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Zami_Cloud:1227137595981430784>"
                        elseif tostring(v.ItemName) == "LamiStaff" or tostring(v.ItemName) == "Lami Staff" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Zami_Staff:1227137615418101760>"
                        elseif tostring(v.ItemName) == "SpiritShard" or tostring(v.ItemName) == "Spirit Shard" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Spirit_Shard:1227137483460972655>"
                        elseif tostring(v.ItemName) == "ResetTree" or tostring(v.ItemName) == "Reset Tree" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Reset_Tree:1227137457028337675>"
                        elseif tostring(v.ItemName) == "Sukuna Finger" or tostring(v.ItemName) == "Cursed Finger" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Sukuna_Finger:1227137497713086495>"
                        elseif tostring(v.ItemName) == "Ulquiorra Sword" or tostring(v.ItemName) == "Ulquiorra's Sword" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Ulmiorra_Blade:1227137541116002334>"
                        elseif tostring(v.ItemName) == "Ulquiorra Spear" or tostring(v.ItemName) == "Ulquiorra's Spear" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Ulq_spear:1227137562305363998>"
                        elseif tostring(v.ItemName) == "Halo" or tostring(v.ItemName) == "Halo" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:Halo:1227137426691063848>"
                        elseif tostring(v.ItemName) == "StrawHat" or tostring(v.ItemName) == "Straw Hat" then 
                            AllTextItemLogo = tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:StrawHat3:1227143233600225321>"
                        end

                        if table.find(SaveSettings["Notifier"]['Select Item'],tostring(i)) or table.find(SaveSettings["Notifier"]['Select Item'],tostring(v.ItemName)) then
                            TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. AllTextItemLogo .. "\n"
                            CountAmountAll = CountAmountAll + 1
                        end
                    end
                else
                ...
                if SaveSettings["Notifier"]["Send Unit Kills"] then
                    ...
                    for i,v in pairs(PlayerDataKills['Slots']) do
                        if table.find(SaveSettings["Notifier"]['Select Unit'],tostring(i)) then
                            ...
                            TextUnitKills = TextUnitKills .. "**[Lv." .. tostring(comma_value(v.Level)) .. "]** " .. tostring(v.Value) .. "  " .. QuirkName .. " | Kill : " .. tostring(comma_value(v.Kills)) .. " :crossed_swords:\n"
                            CountAmountUnit = CountAmountUnit + 1
                        end
                    end
                else
