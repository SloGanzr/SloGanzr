...
if game.PlaceId == 14433762945 then
    ...
    spawn(function()
        while wait() do
            ...
            repeat wait() until LocalPlayer.PlayerGui:FindFirstChild('OrbGui'):FindFirstChild('AutoOpen').CloseButton.Visible == true
        end
    end)
    ...
    spawn(function()
        while wait() do
            ...
            repeat wait() until LocalPlayer.PlayerGui:FindFirstChild('OrbGui'):FindFirstChild('Normal'):FindFirstChild('Buttons').AutoOpenButton.Visible == true
        end
    end)
