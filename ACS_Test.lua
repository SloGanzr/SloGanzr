    ...
    function CheckDungeons(Mode,NameEggs)
        ...
        elseif Mode == "Chest" then
            for i,Dungeons in pairs(game:GetService("Workspace").Worlds.Dungeons:GetChildren()) do
                if Dungeons:FindFirstChild('ZonesCompleted') and Dungeons:FindFirstChildOfClass("Model") then
                   for i,v in next , Dungeons:GetChildren() do
                        if Mode == "Chest" and v:GetAttribute('ZoneRan') and v:FindFirstChild('Chests') and v:FindFirstChild('Chests'):FindFirstChild('DungeonChest') and v:FindFirstChild('Chests'):FindFirstChild('DungeonChest'):FindFirstChild('HumanoidRootPart') then
                            for i,v in next , v:FindFirstChild('Chests'):FindFirstChild('DungeonChest'):FindFirstChild('HumanoidRootPart'):GetChildren() do
                                if v.Name == "ChestPrompt" then
                                    return v
                                end
                            end
                ...
                if Dungeons:FindFirstChild('ZonesCompleted') and Dungeons:FindFirstChildOfClass("Model") then
                   for i,v in next , Dungeons:GetChildren() do
                        if Mode == "Shrine" and v:GetAttribute('ZoneRan') and v:GetAttribute('RoomType') == "ShrineRoom" then
                            if v:FindFirstChild("Shrines"):FindFirstChild("Shrine") and v:FindFirstChild("Shrines"):FindFirstChild("Shrine"):FindFirstChild("0") and v:FindFirstChild("Shrines"):FindFirstChild("Shrine"):FindFirstChild("0"):FindFirstChild("ShrinePrompt") then
                                return v:FindFirstChild("Shrines"):FindFirstChild("Shrine"):FindFirstChild("0"):FindFirstChild("ShrinePrompt")
                            end
                        end
                    end
                end
                    ...
                    for j,k in next , DungeonsFloor:GetChildren() do
                        if k:GetAttribute('ZoneRan') and SaveSettings["Dungeons"]['Auto Dungeon'] then
                            if CheckDungeons("CheckClearFloor") > 0 then
                                if CheckDungeons("FindRoomNextFloor") ~= "Not Found" and SaveSettings["Dungeons"]['Select Next Floor [Method]'] == 'Find Next Floor Go to' then
                                ...
                                elseif CheckDungeons("FindRoomNextFloor") ~= "Not Found" and SaveSettings["Dungeons"]['Select Next Floor [Method]'] == 'Find Next Floor Go to' then
                                    Character.HumanoidRootPart:PivotTo(CheckDungeons("FindRoomNextFloor"):GetModelCFrame())
                                elseif CheckDungeons("FindRoomNextFloor") ~= "Not Found" and SaveSettings["Dungeons"]['Select Next Floor [Method]'] == 'Clear All Floor' then
                                    Character.HumanoidRootPart:PivotTo(CheckDungeons("FindRoomNextFloor"):GetModelCFrame())
                                else
