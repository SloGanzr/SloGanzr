...
if game.PlaceId == 14433762945 then
    ...
    spawn(function()
        while wait() do
            ...
            if LocalPlayer.PlayerGui:FindFirstChild('OrbGui'):FindFirstChild('AutoOpen').CloseButton.Visible == true and not SaveSettings["Egg"]['Click Auto Open Eggs [in Game]'] then
