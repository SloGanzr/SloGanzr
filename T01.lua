    ...
    spawn(function()
        while wait() do
            ...
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true and SaveSettings["Notifier"]['Select Method [Type]'] == "Method 1" then
                ...
                TextDropReroll = (tostring(comma_value(RerollNew)) - tostring(comma_value(RerollOld)))
                TextDropRaidtoken = (tostring(comma_value(RaidtokenNew)) - tostring(comma_value(RaidtokenOld)))
                ...
                for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.BG.Rewards.Rewards.Holder:GetChildren()) do
                    if v:IsA("Frame") then
                        ...
                        elseif v.Image.Image == "rbxassetid://16956799323" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Raid Tokens + " .. tostring(comma_value(TextDropRaidtoken)) or v.Text.Text .. "\n"
                            CountAmount = CountAmount + 1
                        elseif v.Image.Image == "rbxassetid://16203324328" or v.Image.Image == "rbxassetid://15281783959" then
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Reroll + " .. tostring(comma_value(TextDropReroll)) or v.Text.Text .. "\n"
                            CountAmount = CountAmount + 1
    ...
    spawn(function()
        while wait() do
            ...
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true and SaveSettings["Notifier"]['Select Method [Type]'] == "Method 2" then
                ...
                TextDropReroll2 = (tostring((comma_valueRerollNew2)) - tostring(comma_value(RerollOld)))
                TextDropRaidtoken2 = (tostring(comma_value(RaidtokenNew2)) - tostring(comma_value(RaidtokenOld)))
                ...
                for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.BG.Rewards.Rewards.Holder:GetChildren()) do
                    if v:IsA("Frame") then
                        ...
                        if v.Image.Image == "rbxassetid://16088705279" or v.Image.Image == "rbxassetid://16525773698" or v.Image.Image == "rbxassetid://16522983203" then
                            ...
                            CountAmount = CountAmount + 1
                        elseif v.Image.Image == "rbxassetid://16956799323" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Raid Tokens + " .. tostring(comma_value(TextDropRaidtoken2)) or v.Text.Text .. "  <:rt:1225071926427254936>" .. "\n"
                            CountAmount = CountAmount + 1
                        elseif v.Image.Image == "rbxassetid://16203324328" or v.Image.Image == "rbxassetid://15281783959" then
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Reroll + " .. tostring(comma_value(TextDropReroll2)) or v.Text.Text .. "  <:rerolls:1216376860804382860>" .. "\n"
                            CountAmount = CountAmount + 1
                        elseif v.Text.Text == "Tier 1" or v.Text.Text == "Tier 2" or v.Text.Text == "Tier 3" or v.Text.Text == "Tier 4" or v.Text.Text == "Tier 5"
                        or v.Text.Text == "Valentines Portal" then
                        ...
                        elseif v.MainText.Text ~= "" then
                            ...
                            elseif v.Text.Text == "Shiny Wish Dragon" then 
                                ...
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". " .. v.Text.Text .. " + 1  :fire:\n"
                                CountAmount = CountAmount + 1
                            end
                        end
                    end
                ...
                if SaveSettings["Notifier"]["Send Unit Kills"] then
                    ...
                    for i,v in pairs(PlayerDataKills['Slots']) do
                        if table.find(SaveSettings["Notifier"]['Select Unit'],tostring(i)) then
                            ...
                            if QuirkName == "Glitched" then QuirkName = "<:Glitched:1216852874521477251>"
                            elseif QuirkName == "Avatar" then QuirkName = "<:Avatar:1205745952527491092>"
                            elseif QuirkName == "Overlord" then QuirkName = "<:Overlord:1205745900836622366>"
                            elseif QuirkName == "Shinigami" then QuirkName = "<:Shinigami:1205746002905145354>"
                            elseif QuirkName == "Entrepreneur" then QuirkName = "<:Entrepreneur:1205746049881481246>"
                            elseif QuirkName == "All Seeing" then QuirkName = "<:AllSeeing:1205745808700481547>"
                            --AnotherQuirk
                            elseif QuirkName ~= "Glitched" or QuirkName ~= "Avatar" or QuirkName ~= "Overlord" or QuirkName ~= "Shinigami" 
                            or QuirkName ~= "Entrepreneur" or QuirkName ~= "All Seeing" then QuirkName = "(" .. QuirkName .. ")" end
