        ...
        while wait() do
            if SaveSettings["Pet"]['Auto Reroll Mulit Quirk'] then
                ...
                if PetDataQuirk and PetDataQuirk['ID'] then
                    ...
                    if not table.find(SaveSettings["Pet"]['Select Rarity [Mulit Quirk]'],NowPassives1) and tonumber(SaveSettings["Pet"]['Select Slot [Mulit Quirk]']) == 1 and PassiveSlots == 1 then
						TableMulitQuirk = {}
