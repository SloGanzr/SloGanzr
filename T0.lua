...
if game.PlaceId == 14433762945 then
    ...
    spawn(function()
        while wait() do
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("OrbGui") and SaveSettings["Egg"]['Auto Open Egg'] and SaveSettings["Egg"]['Click Auto Open Eggs [in Game]'] then
                wait(3)
