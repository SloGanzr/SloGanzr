...
if game.PlaceId == 14433762945 then
    ...
    spawn(function()
        while wait() do
            ...
            if LocalPlayer.PlayerGui:FindFirstChild('OrbGui'):FindFirstChild('Normal'):FindFirstChild('Buttons'):FindFirstChild('AutoOpenButton').Button.Visible == true and SaveSettings["Egg"]['Click Auto Open Eggs [in Game]'] then
                ClickButton(LocalPlayer.PlayerGui.OrbGui.Normal.Buttons.AutoOpenButton.Button)
            elseif LocalPlayer.PlayerGui:FindFirstChild('OrbGui'):FindFirstChild('Normal'):FindFirstChild('Buttons'):FindFirstChild('AutoOpenButton').Button.Visible == false and not SaveSettings["Egg"]['Click Auto Open Eggs [in Game]'] then
                ClickButton(LocalPlayer.PlayerGui.OrbGui.AutoOpen.CloseButton)
            end

            repeat wait() until not SaveSettings["Egg"]['Auto Open Egg']
