        ...
        while wait() do
            if SaveSettings["Pet"]['Auto Reroll Mulit Quirk'] then
                ...
                if PetDataQuirk and PetDataQuirk['ID'] then
                    ...
                    local NowPassives0 = 'NowPassives' ..tonumber(SaveSettings["Pet"]['Select Slot [Mulit Quirk]'])
                    print(NowPassives0)

                    StatusPetsQuirkMulit.Options:ChangeText('Quirk 1 : '.. NowPassives1 .. '\nQuirk 2 : '.. NowPassives2)
                    if not table.find(SaveSettings["Pet"]['Select Rarity [Mulit Quirk]'],NowPassives0) then --and tonumber(SaveSettings["Pet"]['Select Slot [Mulit Quirk]']) == 1 then
						TableMulitQuirk = {}
                        ...
                        if table.find(SaveSettings["Pet"]['Select Rarity [Mulit Quirk]'],NowPassives0) and TableMulitQuirk[NowPassives0] then
                            TableMulitQuirk[NowPassives0] = nil
                        end
                        if table.find(SaveSettings["Pet"]['Select Rarity [Mulit Quirk]'],NowPassives0) and TableMulitQuirk[NowPassives0] then
                            TableMulitQuirk[NowPassives0] = nil
                        end
                        ...
                        --fixtwinQuirk
                        --[[if tostring(NowPassives1) == TableMulitQuirk[NowPassives2] then
                            TableMulitQuirk[NowPassives1] = nil
                        end
                        if tostring(NowPassives2) == TableMulitQuirk[NowPassives1] then
