                    ...
                    if v:IsA("Frame") then
                        ...
                        elseif v.MainText.Text ~= "" then
                            ...
                            if v.Text.Text == "HeavenlyChad" or v.Text.Text == "HeavenlyChad (Jotaro OH)" then
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". HeavenlyChad (Jotaro OH) + " .. CountItems .. "  <:YO:1226871732036702240>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Red Pirate (Young)" or v.Text.Text == "Red Pirate (Young) (Shanks)" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Red Pirate (Young) (YoungShanks) + " .. CountItems .. "  <:YS1:1226869137813536808>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Shiny Wish Dragon" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Shiny Wish Dragon + " .. CountItems .. "  :dragon:\n"
                                CountAmount = CountAmount + 1
                            --Item_Logoa
                            elseif v.Text.Text == "WishBall1" or v.Text.Text == "Wish Ball 1" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Wish Ball 1 + " .. CountItems .. "  <:Wish_Balls:1227137580785602671>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "WishBall2" or v.Text.Text == "Wish Ball 2" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Wish Ball 2 + " .. CountItems .. "  <:Wish_Balls:1227137580785602671>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "WishBall3" or v.Text.Text == "Wish Ball 3" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Wish Ball 3 + " .. CountItems .. "  <:Wish_Balls:1227137580785602671>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "WishBall4" or v.Text.Text == "Wish Ball 4" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Wish Ball 4 + " .. CountItems .. "  <:Wish_Balls:1227137580785602671>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "WishBall5" or v.Text.Text == "Wish Ball 5" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Wish Ball 5 + " .. CountItems .. "  <:Wish_Balls:1227137580785602671>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "WishBall6" or v.Text.Text == "Wish Ball 6" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Wish Ball 6 + " .. CountItems .. "  <:Wish_Balls:1227137580785602671>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "WishBall7" or v.Text.Text == "Wish Ball 7" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Wish Ball 7 + " .. CountItems .. "  <:Wish_Balls:1227137580785602671>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "MSymbol" or v.Text.Text == "Mean Symbol" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Mean Symbol + " .. CountItems .. "  <:Mean_Symbol:1227137443984310333>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "RightEarring" or v.Text.Text == "Right Earring" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Right Earring + " .. CountItems .. "  <:Earrings:1227137412103147532>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "LeftEarring" or v.Text.Text == "Left Earring" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Left Earring + " .. CountItems .. "  <:Earrings:1227137412103147532>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "SixEyes" or v.Text.Text == "Six Eyes" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Six Eyes + " .. CountItems .. "  <:Six_Eye:1227137469770764319>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Tor Headband" or v.Text.Text == "Tor's Headband" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Tor's Headband + " .. CountItems .. "  <:Tors_Headband:1227137526213640223>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Tor Cloak" or v.Text.Text == "Tor's Cloak" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Tor's Cloak + " .. CountItems .. "  <:Tors_Cloak:1227137511650758668>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "LamiCloud" or v.Text.Text == "Lami Cloud" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Lami Cloud + " .. CountItems .. "  <:Zami_Cloud:1227137595981430784>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "LamiStaff" or v.Text.Text == "Lami Staff" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Lami Staff + " .. CountItems .. "  <:Zami_Staff:1227137615418101760>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "SpiritShard" or v.Text.Text == "Spirit Shard" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Spirit Shard + " .. CountItems .. "  <:Spirit_Shard:1227137483460972655>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "ResetTree" or v.Text.Text == "Reset Tree" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Reset Tree + " .. CountItems .. "  <:Reset_Tree:1227137457028337675>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Sukuna Finger" or v.Text.Text == "Cursed Finger" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Cursed Finger + " .. CountItems .. "  <:Sukuna_Finger:1227137497713086495>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Ulquiorra Sword" or v.Text.Text == "Ulquiorra's Sword" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Ulquiorra's Sword + " .. CountItems .. "  <:Ulmiorra_Blade:1227137541116002334>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Ulquiorra Spear" or v.Text.Text == "Ulquiorra's Spear" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Ulquiorra's Spear + " .. CountItems .. "  <:Ulq_spear:1227137562305363998>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Halo" or v.Text.Text == "Halo" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Halo + " .. CountItems .. "  <:Halo:1227137426691063848>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "StrawHat" or v.Text.Text == "Straw Hat" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Straw Hat + " .. CountItems .. "  <:StrawHat3:1227143233600225321>\n"
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Candy" or v.Text.Text == "Candy" then 
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Candy + " .. CountItems .. "  <:Candy:1227137395686899723>\n"
                                CountAmount = CountAmount + 1
                            else
                                if v.Text.Text == v.Text.Text then CountItems = CountItems + 1 end
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". " .. v.Text.Text .. " + " .. CountItems .." :scales:\n"
                                CountAmount = CountAmount + 1
                            end
                        end
                    end
