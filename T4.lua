            ...
            if SaveSettings["Pet"]['Auto Reroll Mulit Quirk'] then
                ...
                if PetDataQuirk and PetDataQuirk['ID'] then
                    ...
                    if not table.find(SaveSettings["Pet"]['Select Rarity [Mulit Quirk]'],NowPassives1) and tonumber(SaveSettings["Pet"]['Select Slot [Mulit Quirk]']) == 1 then
                        ...
                        --fixtwinQuirk
                        if NowPassives1 == TableMulitQuirk[NowPassives2] and TableMulitQuirk[NowPassives2] then
                            TableMulitQuirk[NowPassives2] = {[tostring(NowPassives1)] = nil }
                            TableMulitQuirk[NowPassives2] = {[tostring(NowPassives1)] = "nil" }
                        end
                        if NowPassives2 == TableMulitQuirk[NowPassives1] and TableMulitQuirk[NowPassives1] then
                            TableMulitQuirk[NowPassives1] = {[tostring(NowPassives2)] = nil }
                            TableMulitQuirk[NowPassives1] = {[tostring(NowPassives2)] = "nil" }
                        end
