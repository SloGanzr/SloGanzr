    ...
    spawn(function()
        while wait() do
            ...
            if SaveSettings["Egg"]['Click Auto Open Eggs [in Game]'] then
                if LocalPlayer.PlayerGui:FindFirstChild('OrbGui'):FindFirstChild('Normal'):FindFirstChild('Buttons'):FindFirstChild('AutoOpenButton').Button.Visible == true then
                    ClickButton(LocalPlayer.PlayerGui.OrbGui.Normal.Buttons.AutoOpenButton.Button)
                end
            else
                if LocalPlayer.PlayerGui:FindFirstChild('OrbGui'):FindFirstChild('Normal'):FindFirstChild('Buttons'):FindFirstChild('AutoOpenButton').Button.Visible == false then
