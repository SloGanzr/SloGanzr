...
if game.PlaceId == 14433762945 then
    ...
    spawn(function()
        while wait() do
            if SaveSettings["Egg"]['Click Auto Open Eggs [in Game]'] or SaveSettings["Egg"]['Click Auto Open Eggs [in Game]'] == true then
    ...
    spawn(function()
        while wait() do
            if not SaveSettings["Egg"]['Click Auto Open Eggs [in Game]'] or SaveSettings["Egg"]['Click Auto Open Eggs [in Game]'] == false then
