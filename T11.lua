            ...
            if SaveSettings["Pet"]['Auto Reroll Mulit Quirk'] then
                ...
                if PetDataQuirk and PetDataQuirk['ID'] then
                    ...
                    if not table.find(SaveSettings["Pet"]['Select Rarity [Mulit Quirk]'],NowPassives1) and tonumber(SaveSettings["Pet"]['Select Slot [Mulit Quirk]']) == 1 then
                        ...
                        --fixtwinQuirk
                        if table.find(SaveSettings["Pet"]['Select Rarity [Mulit Quirk]'],NowPassives1) and NowPassives1 == TableMulitQuirk[NowPassives2] then
                            TableMulitQuirk[NowPassives2] = {
                                [NowPassives1] = nil
                            }
                        end
                        if table.find(SaveSettings["Pet"]['Select Rarity [Mulit Quirk]'],NowPassives2) and NowPassives2 == TableMulitQuirk[NowPassives1] then
