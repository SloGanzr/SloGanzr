...
PandaAuth = loadstring(game:HttpGet('https://raw.githubusercontent.com/Panda-Repositories/PandaKS_Libraries/main/library/LuaLib/ROBLOX/PandaBetaLib.lua'))() or tryLoadURL('https://pandadevelopment.net/servicelib?service='..ServiceID..'&core='..LibType..'&param='..LibVersion)
        ...
        function WebhookMethod2()
            ...
            --if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true and SaveSettings["Notifier"]['Select Method [Type]'] == "Method 2" then
                ...
                for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.BG.Rewards.Rewards.Holder:GetChildren()) do
                    if v:IsA("Frame") then                  
                        if v.Image.Image == "rbxassetid://16088705279" or v.Image.Image == "rbxassetid://16525773698" or v.Image.Image == "rbxassetid://16522983203" then
                            TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". Emeralds + " .. v.Text.Text .. "  <:emerald:1204766658397343805>" .. "\n"
                            CountAmountTest = CountAmountTest + 1
                        elseif v.Image.Image == "rbxassetid://16956799323" then 
                            TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". Raid Tokens + " .. v.Text.Text .. "  <:rt:1225071926427254936>" .. "\n"
                            CountAmountTest = CountAmountTest + 1
                        elseif v.Image.Image == "rbxassetid://16203324328" or v.Image.Image == "rbxassetid://15281783959" then
                            TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". Reroll + " .. v.Text.Text .. "  <:rerolls:1216376860804382860>" .. "\n"
                            CountAmountTest = CountAmountTest + 1
                        end
                    end
                end
                ...
                for i,v in pairs(get_Units_Owner()) do
                    Table_All_Items_New_data[v["UnitName"]]['Amount'] = Table_All_Items_New_data[v["UnitName"]]['Amount'] + 1
                end
                
                for i,v in pairs(Table_All_Items_New_data) do
                    if tonumber(v['Amount']) > 0 and tonumber(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) > 0 then
                        if tonumber(v['Amount']) > 0 and tonumber(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) > 0 then

                            if tostring(v['Name']) == "HeavenlyChad" or tostring(v['Name']) == "HeavenlyChad (Jotaro OH)" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:YO:1226871732036702240>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "Red Pirate (Young)" or tostring(v['Name']) == "Red Pirate (Young) (Shanks)" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:YS1:1226869137813536808>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "Shiny Wish Dragon" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  :dragon:\n"
                                CountAmountTest = CountAmountTest + 1
                            --Item_Logo
                            elseif tostring(v['Name']) == "WishBall1" or tostring(v['Name']) == "Wish Ball 1" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Wish_Balls:1227137580785602671>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "WishBall2" or tostring(v['Name']) == "Wish Ball 2" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Wish_Balls:1227137580785602671>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "WishBall3" or tostring(v['Name']) == "Wish Ball 3" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Wish_Balls:1227137580785602671>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "WishBall4" or tostring(v['Name']) == "Wish Ball 4" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Wish_Balls:1227137580785602671>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "WishBall5" or tostring(v['Name']) == "Wish Ball 5" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Wish_Balls:1227137580785602671>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "WishBall6" or tostring(v['Name']) == "Wish Ball 6" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Wish_Balls:1227137580785602671>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "WishBall7" or tostring(v['Name']) == "Wish Ball 7" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Wish_Balls:1227137580785602671>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "MSymbol" or tostring(v['Name']) == "Mean Symbol" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Mean_Symbol:1227137443984310333>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "RightEarring" or tostring(v['Name']) == "Right Earring" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Earrings:1227137412103147532>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "LeftEarring" or tostring(v['Name']) == "Left Earring" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Earrings:1227137412103147532>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "SixEyes" or tostring(v['Name']) == "Six Eyes" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Six_Eye:1227137469770764319>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "Tor Headband" or tostring(v['Name']) == "Tor's Headband" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Tors_Headband:1227137526213640223>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "Tor Cloak" or tostring(v['Name']) == "Tor's Cloak" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Tors_Cloak:1227137511650758668>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "LamiCloud" or tostring(v['Name']) == "Lami Cloud" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Zami_Cloud:1227137595981430784>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "LamiStaff" or tostring(v['Name']) == "Lami Staff" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Zami_Staff:1227137615418101760>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "SpiritShard" or tostring(v['Name']) == "Spirit Shard" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Spirit_Shard:1227137483460972655>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "ResetTree" or tostring(v['Name']) == "Reset Tree" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Reset_Tree:1227137457028337675>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "Sukuna Finger" or tostring(v['Name']) == "Cursed Finger" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Sukuna_Finger:1227137497713086495>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "Ulquiorra Sword" or tostring(v['Name']) == "Ulquiorra's Sword" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Ulmiorra_Blade:1227137541116002334>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "Ulquiorra Spear" or tostring(v['Name']) == "Ulquiorra's Spear" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Ulq_spear:1227137562305363998>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "Halo" or tostring(v['Name']) == "Halo" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Halo:1227137426691063848>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "StrawHat" or tostring(v['Name']) == "Straw Hat" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:StrawHat3:1227143233600225321>\n"
                                CountAmountTest = CountAmountTest + 1
                            elseif tostring(v['Name']) == "Candy" or tostring(v['Name']) == "Candy" then 
                                TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]  <:Candy:1227137395686899723>\n"
                                CountAmountTest = CountAmountTest + 1
                            end
                        else
                            TextDropLabelTest = TextDropLabelTest .. tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " + " .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]\n"
                            --warn(tostring(CountAmountTest) .. ". " .. tostring(v['Name']) .. " +" .. tostring(v['Amount'] - Table_All_Items_Old_data[i]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]\n")
                            CountAmountTest = CountAmountTest + 1
                        end
                    end
                end
                        ...
                        if table.find(SaveSettings["Notifier"]['Select Unit'],tostring(i1)) then
                            ...
                            for i2,v2 in pairs(PlayerDataKillsInfo['UnitData']) do
                                if tostring(v1.UnitID) == tostring(v2.UnitID) then
                                    ...
                                    if QuirkName == "Glitched" then QuirkName = "<:Glitched2:1227818072316841994>"
    ...
    spawn(function()
        while wait() do
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true then
               --repeat wait() until game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.Enabled == true
               if SaveSettings["Notifier"]['Select Method [Type]'] == "Method 1" then
                    pcall(function() WebhookMethod1() end)
                    repeat wait() until game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.Enabled == true
                    warn("Wait Retry ,Next or leave")
                    wait(1.5)
               elseif SaveSettings["Notifier"]['Select Method [Type]'] == "Method 2" then
                    pcall(function() WebhookMethod2() end)
                    repeat wait() until game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.Enabled == true
                    warn("Wait Retry ,Next or leave")
                    wait(1.5)
               end
