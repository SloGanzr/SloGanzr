_G.HideUiTopbat = true
    ...
    if table.find(PlaceId_AWTD,game.PlaceId) then
       ...
       -- game:GetService("Players").LocalPlayer.PlayerGui:WaitForChild("TouchGui")
        ...
        ------------------------------------------------------ [[ Function ]] ------------------------------------------------------
    --Auto Farm Story
        if table.find(PlaceId_AWTD,game.PlaceId) and SaveSettings["Auto Farm"]['Auto Farm Select'] == true and SaveSettings["Auto Farm"]["Select Story or Events "] == "Story" and game:GetService("Workspace").Map:FindFirstChild("Warp") then
    ...
    --Auto Farm Event & All
        if table.find(PlaceId_AWTD,game.PlaceId) and SaveSettings["Auto Farm"]['Auto Farm Select'] == true and SaveSettings["Auto Farm"]["Select Story or Events "] == "Events" and game:GetService("Workspace").Map:FindFirstChild("Warp") then
            wait(tonumber(SaveSettings["Auto Farm"]["CD Start Auto Farm"])) do
            Character.HumanoidRootPart:PivotTo(game:GetService("Workspace").Map.Warp.WarpRoom.Warp.CFrame)
            wait(.5)
                local args = {
