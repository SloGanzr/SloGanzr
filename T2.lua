...
if PandaAuth then
    ...
    if not success then
        keyless = true
        print("-------] HolyShz Loaded [-------")
        warn("Failed to retrieve AuthLink. PandaAuth Error, Holyshz is Keyless!!")
        print("--------------------------------")
    end
else
    keyless = true
    print("-------] HolyShz Loaded [-------")
    warn("PandaAuth Error, Holyshz is Keyless!!")
    print("--------------------------------")
end
    ...
    spawn(function()
        while wait() do
            ...
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true and SaveSettings["Notifier"]['Select Method [Type]'] == "Method 2" then
                ...
                local TextDropLabel = ""
                local Table_Items_Drops = {}
                local CountSameItemAmount = 1

                for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.EndGameUI.BG.Rewards.Rewards.Holder.Reward:FindFirstChild("Viewport"):FindFirstChild("WorldModel"):GetChildren()) do
                    if v:IsA("Model") then
                        if v.Name == "WishBall1" or v.Name == "Wish Ball 1" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Wish_Balls:1227137580785602671>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        ...
                        elseif v.Name == "MSymbol" or v.Name == "Mean Symbol" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Mean_Symbol:1227137443984310333>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "RightEarring" or v.Name == "Right Earring" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Earrings:1227137412103147532>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        ...
                        elseif v.Name == "SixEyes" or v.Name == "Six Eyes" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Six_Eye:1227137469770764319>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "Tor Headband" or v.Name == "Tor's Headband" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Tors_Headband:1227137526213640223>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "Tor Cloak" or v.Name == "Tor's Cloak" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Tors_Cloak:1227137511650758668>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "LamiCloud" or v.Name == "Lami Cloud" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Zami_Cloud:1227137595981430784>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "LamiStaff" or v.Name == "Lami Staff" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Zami_Staff:1227137615418101760>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "SpiritShard" or v.Name == "Spirit Shard" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Spirit_Shard:1227137483460972655>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "ResetTree" or v.Name == "Reset Tree" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Reset_Tree:1227137457028337675>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "Sukuna Finger" or v.Name == "Cursed Finger" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Sukuna_Finger:1227137497713086495>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "Ulquiorra Sword" or v.Name == "Ulquiorra's Sword" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Ulmiorra_Blade:1227137541116002334>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "Ulquiorra Spear" or v.Name == "Ulquiorra's Spear" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Ulq_spear:1227137562305363998>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "Halo" or v.Name == "Halo" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Halo:1227137426691063848>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "StrawHat" or v.Name == "Straw Hat" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:StrawHat3:1227143233600225321>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        elseif v.Name == "Candy" or v.Name == "Candy" then 
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  <:Candy:1227137395686899723>\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        else
                            TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". TEST NEW : " .. tostring(v.Name) .. " + " .. tostring(CountSameItemAmount) .. "  :scales:\n"
                            if tostring(v.Name) == tostring(v.Name) then CountSameItemAmount = CountSameItemAmount +1 end
                            CountAmount = CountAmount + 1
                        end
                    end
