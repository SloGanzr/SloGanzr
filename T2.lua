            ...
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true and SaveSettings["Notifier"]['Select Method [Type]'] == "Method 1" then
                ...
                if SaveSettings["Notifier"]["Send All Item"] then
                    ...
                    for i,v in pairs(TableData['ItemData']) do
                        ...
                        if v.ItemName == "Genos Core" or v.ItemName == "Genos Core" then v.ItemName = "Genos Core" end
                    ...
                    if v:IsA("Frame") then
                        ...
                        elseif v.MainText.Text ~= "" then
                            ...
                            elseif v.Text.Text == "Strongest Aline" or v.Text.Text == "Boros" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Boros + 1  <:BorosModel:1233808593665523772>\n"
                                CountAmount = CountAmount + 1
                            ...
                            elseif v.Text.Text == "Senzu Bean" or v.Text.Text == "Super Bean" then 
                                ...
                                CountAmount = CountAmount + 1
                            elseif v.Text.Text == "Energy Core" or v.Text.Text == "Energy Core" then 
                                TextDropLabel = TextDropLabel .. tostring(CountAmount) .. ". Energy Core + 1  <:EnergyCore:1233511910192709763>\n"
                                CountAmount = CountAmount + 1
                            else
                    ...
                    for i,v in pairs(TableDataEXP['ExperienceItemsData']) do
                        ...
                        if table.find(SaveSettings["Notifier"]['Select Item'],tostring(i)) or table.find(SaveSettings["Notifier"]['Select Item'],tostring(v.ItemName)) then
                            ...
                            elseif v.ItemName == "Energy Core" or v.ItemName == "Energy Core" then
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  <:EnergyCore:1233511910192709763>\n"
                                CountAmountAll = CountAmountAll + 1
                            else
                                TextDropLabelAll = TextDropLabelAll .. tostring(CountAmountAll) .. ". " .. tostring(v.ItemName) .. " -> " ..  tostring(comma_value(v.Amount)) .. "  :anger:\n"
                                CountAmountAll = CountAmountAll + 1
                    ...
                    ["embeds"] = {
                        {
                            ["title"] = "**Anime Last Stand **:",
                            ["author"] = {
                                ["name"] = "HolyShz Webhook - Anime Last Stand | Method 2 TEST Hide Name ",
                                ["icon_url"] = "https://tr.rbxcdn.com/1f1fe656ca3c50139302f46cb5431b32/150/150/Image/png",
                            },
                            ["image"] = {
                                ["url"] = "https://tr.rbxcdn.com/e893b8fc4ca334bdf84d9ae82e277667/768/432/Image/Png",
