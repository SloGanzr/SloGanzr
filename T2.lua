...
if table.find(PlaceId_ALS,game.PlaceId) then
    ...
    for i,v in pairs(TableData) do
        Table_All_Items_Old_data[v]['Amount'] = v
    end
    ------------------------------------------------------ [[ Function First ]] ------------------------------------------------------
        ...
        while wait() do
            ...
            if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild('EndGameUI') and SaveSettings["Notifier"]["Send After End Game"] == true then
               ...
               --TEST 
                ...
                for i,v in pairs(TableData) do
                    Table_All_Items_New_data[v]['Amount'] = v
                end
                    ...
                    if v['Amount'] > 0 and (v['Amount'] - Table_All_Items_Old_data[i]['Amount']) > 0 then
                        if v['Amount'] then
                            if string.gsub(i, "%D", "") == "" then
                                TextDropLabelTEST = TextDropLabelTEST .. tostring(AmountAmountTest) .. ". " .. tostring(v['ItemName']) .. " : x" .. tostring(v['Amount'] - Table_All_Items_Old_data[v]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]\n"
                            else
                                TextDropLabelTEST = TextDropLabelTEST .. tostring(AmountAmountTest) .. ". " .. tostring(v['ItemName']) .. " Tier " .. tostring(string.gsub(i, "%D", "")) .. " : x" .. tostring(v['Amount'] - Table_All_Items_Old_data[v]['Amount']) .. " [Total : " .. tostring(v['Amount']) .. "]\n"
                            end
