...
if game.PlaceId == 14433762945 then
    ...
    function ClickOpenEgg()
        for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.OrbGui:FindFirstChild("Normal"):FindFirstChild("Buttons"):FindFirstChild("AutoOpenButton"):GetChildren()) do
            if v.Name == "Button" and v:FindFirstChild("Button") then
                if v:FindFirstChild("Button") then
                    wait(5)
                    ClickButton(v.Button)
                    --ClickButton(game:GetService("Players").LocalPlayer.PlayerGui.OrbGui.Normal.Buttons.AutoOpenButton.Button)
                    repeat wait() until not v:FindFirstChild("Button")
                end
            end
        end
    end
